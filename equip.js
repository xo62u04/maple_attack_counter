...
const SET_EFFECT_TYPES = [
  { value: 'mainStatPct',  label: '主%' },
  { value: 'mainStatFlat', label: '主+' },
  { value: 'subStatPct',   label: '副%' },
  { value: 'subStatFlat',  label: '副+' },
  { value: 'allStatPct',   label: '全屬%' },
  { value: 'allStatFlat',  label: '全屬+' },
  { value: 'atkPct',       label: '攻%' },
  { value: 'atkFlat',      label: '攻+' },
